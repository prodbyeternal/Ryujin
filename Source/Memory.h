...
#endif
{
    ...
    present = PatternFinder{ gameOverlayRenderer.getCodeSection().raw(), patternNotFoundHandler}("68 ? ? ? ? 6A 01 68 ? ? ? ? 68 ? ? ? ? FF 76 44 E8 ? ? ? ? 83 C4 14"_pat).add(8).as<std::uintptr_t>();
    reset = PatternFinder{ gameOverlayRenderer.getCodeSection().raw(), patternNotFoundHandler }("68 ? ? ? ? 6A 01 68 ? ? ? ? 68 ? ? ? ? FF 76 40 E8 ? ? ? ? 83 C4 14"_pat).add(8).as<std::uintptr_t>();
